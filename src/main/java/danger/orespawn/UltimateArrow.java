...
public class UltimateArrow extends EntityArrow
{
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            Entity var9 = null;
            final List var10 = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0, 1.0, 1.0));
            double var11 = 0.0;
            for (int var12 = 0; var12 < var10.size(); ++var12) {
                ...
                if (var13.canBeCollidedWith() && (var13 != this.shootingEntity || this.ticksInAir >= 5) && !(var13 instanceof Elevator)) {
                    ...
                    final AxisAlignedBB var15 = var13.boundingBox.expand((double)var14, (double)var14, (double)var14);
            ...
            if (var8 != null) {
                if (var8.entityHit != null) {
                    ...
                    float var19 = (float)MathHelper.ceiling_double_int(var18 * (double)OreSpawnMain.UltimateBowDamage);
                    ...
                    if (this.shootingEntity == null) {
                        var20 = DamageSource.causeArrowDamage((EntityArrow)this, (Entity)this);
                    }
                    else {
                    ...
                    if (var8.entityHit.attackEntityFrom(var20, var19)) {
                        if (var8.entityHit instanceof EntityLiving) {
                            ...
                            if (this.knockbackStrength > 0) {
                                ...
                                if (var22 > 0.0f) {
                                    var8.entityHit.addVelocity(this.motionX * this.knockbackStrength * 0.6000000238418579 / var22, 0.1, this.motionZ * this.knockbackStrength * 0.6000000238418579 / var22);
                                }
                            }
